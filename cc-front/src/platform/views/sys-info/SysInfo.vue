          ...
          <a-card :bordered="false">
            <div>
              ...
              <a-card :bordered="false" class="app-cpu-item app-cpu-number">
                <div class="app-flex">
                  <app-dynamic-icon iconName="SvgIconCpu" :iconProps="{ class: 'icon' }" />
            ...
            <div class="app-sys-info-right-row">
              ...
              <a-card :bordered="false" class="app-memory-item app-memory-total">
                <div class="app-flex">
                  <app-dynamic-icon iconName="SvgIconMemory" :iconProps="{ class: 'icon' }" />
                  <div class="app-flex app-flex-direction-column">
...
import SysInfoApi from '/@/platform/apis/sys-info-api';
import HttpResultUtils from '/@/platform/commons/utils/http-result-utils';
import diskIcon from '/@/assets/platform/img/sys-info/disk.svg';
