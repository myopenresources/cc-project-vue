...
import userNameValidator from '/@/platform/validators/user-name-validator';
import idCardValidator from '/@/platform/validators/id-card-validator';
import emailValidator from '/@/platform/validators/email-validator';
import mobileValidator from '/@/platform/validators/mobile-validator';
