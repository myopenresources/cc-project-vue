...
* @version 1.0
*/
@Component("system.designatedDeptSubsProcessor")
public class DesignatedDeptSubsProcessorImpl  implements DataPermissionsProcessorInterface {
	...
	public void buildSql(MetaObject metaObject, String sourceSql, DataPermissionsBean dataPermissionsBean,Map<String, Object> parameter) throws Exception {
		...
		for(int i=0;i<designatedDeptList.size();i++) {
			...
			String leftVaKey = "designatedDeptSubsLeft"+ i;
			String rightVaKey = "designatedDeptSubsRight"+ i;
